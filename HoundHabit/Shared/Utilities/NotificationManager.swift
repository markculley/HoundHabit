...
struct NotificationManager {
    ...
    static let reminderEnabledKey        = "HoundHabit.reminder.enabled"
    static let reminderHourKey           = "HoundHabit.reminder.hour"
    static let reminderMinuteKey         = "HoundHabit.reminder.minute"
    static let dailyReminderIdentifier   = "HoundHabit.dailyReminder"
    ...
    func scheduleReminder(hour: Int, minute: Int) async throws {
        ...
        content.body  = "Time to train! Log a session in Hound Habit."
